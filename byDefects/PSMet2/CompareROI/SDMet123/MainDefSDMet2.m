...
pathAplicationSilhouette=fullfile(SDMet2Path,'sFrutas');
...
for n=1:imageCount
    ...
    ProcessImgSoft(pathImages, SDMet2Path, imageNameP, rectangleList, objectAreaBR, LchannelMin, LchannelMax, AchannelMin, AchannelMax, BchannelMin, BchannelMax );
    ExtractDefDetectImgSoftSDMet2(pathImages, SDMet2Path, imageNameP, candidateFile, sizeContours);
    %if n==1
    %    break;
    %end %if n==11
end %

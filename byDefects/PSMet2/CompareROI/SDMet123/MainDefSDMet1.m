...
pathAplicationSilhouette=fullfile(SDMet1Path,'sFrutas');
...
candidateFile=fullfile(pathResults,'aCandidatosSDMet1.csv'); % output file defect candidates
...
for n=1:imageCount
    ...
    ProcessImgSoft(pathImages, SDMet1Path, imageNameP, rectangleList, objectAreaBR, LchannelMin, LchannelMax, AchannelMin, AchannelMax, BchannelMin, BchannelMax );
    ExtractDefDetectImgSoftSDMet1(pathImages, SDMet1Path, imageNameP, candidateFile, sizeContours);
    %if n==1
    %    break;
    %end %if n==11
end %

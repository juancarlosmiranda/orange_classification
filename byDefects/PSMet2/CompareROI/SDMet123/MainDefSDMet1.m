...
pathAplication=fullfile(mainPath,'tmpToLearn','SDMet1'); % TODO VERIFICAR
...
for n=1:imageCount
    ...
    ExtractDefDetectImgSoftSDMet1(pathImages, pathAplication, imageNameP, candidateFile, sizeContours);
    %if n==1
    %    break;
    %end %if n==11
end %
